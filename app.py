...
def load_main_data():
    try:
        # Προσοχή: Το όνομα του αρχείου είναι αυτό που ανέβασες στο GitHub
        with zipfile.ZipFile("THESIS_WITH_ORIENTATION.zip", 'r') as z:
            # Αγνοούμε τα κρυφά αρχεία του Mac
            ...
            # Διαβάζουμε το αρχείο στη μνήμη (για να μην έχουμε σφάλματα)
